...
import com.oeong.ui.dev.FileFormat;
 ...
 */
public class FormatMenuItem implements MenuAction {
    /**
     * 当前菜单名称
     *
     * @return
    ...
    public @NotNull JPanel getContainer(Project project) {
        FileFormat fileFormat = new FileFormat(project);
        return fileFormat.getContainer();
    }
}

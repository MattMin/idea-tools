...
import com.oeong.ui.dev.ConversionSql;
 ...
 */
public class ConversionMenuItem implements MenuAction {
    /**
     * 当前菜单名称
     *
     * @return
    ...
    public @NotNull JPanel getContainer(Project project) {
        ConversionSql conversionSql = new ConversionSql(project);
        return conversionSql.getContainer();
    }
}

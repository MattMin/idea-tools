...
public class ClipboardGroupComponent extends JBPanel<ClipboardGroupComponent> implements NullableComponent {
    ...
    public ClipboardGroupComponent() {
        ...
        // myTitle
        JBLabel myTitle = new JBLabel("Clipboard");
    ...
    public void add(ClipboardComponent messageComponent) {
        myList.add(messageComponent);
        messages.add(messageComponent.getAnswer());
        updateLayout();
        scrollToBottom();
        updateUI();
    }

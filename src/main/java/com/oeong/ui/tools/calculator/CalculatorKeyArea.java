...
public class CalculatorKeyArea extends JPanel {
    ...
    private final JButton B_backspace = new JButton(AllIcons.Actions.Back); // 退格，清除输入的最后一位
    // 第2行
    ...
    public void initUI() {
        ...
        B_random.setToolTipText("Uniform discrete distribution - Random natural number including 0 U{0,10\\^2} - Random variable.");
